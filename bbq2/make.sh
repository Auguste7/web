...
javac -cp $TOP_DIR/WEB-INF/classes:$LIBPATH  WEB-INF/classes/web/Req.java -Xlint:deprecation
javac -cp $TOP_DIR/classes:$LIBPATH  WEB-INF/classes/HelloServlet.java   
